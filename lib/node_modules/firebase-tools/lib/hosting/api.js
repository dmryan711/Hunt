...
exports.cleanAuthState = exports.getCleanDomains = exports.removeAuthDomain = exports.addAuthDomain = exports.createRelease = exports.cloneVersion = exports.deleteChannel = exports.updateChannelTtl = exports.createChannel = exports.listChannels = exports.getChannel = exports.normalizeName = void 0;
...
function removeAuthDomain(project, url) {
    return __awaiter(this, void 0, void 0, function* () {
        const domains = yield auth_1.getAuthDomains(project);
        if (!domains.length) {
            return domains;
